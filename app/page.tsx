    ...
    <>
          ...
          <div className="vlt-navbar-inner">
            <div className="vlt-navbar-inner--left">
              ...
              <a className="vlt-navbar-logo" href="https://thetrinityweb.com.br/">
                <img className="black" src="/assets/img/root/logo-black.webp" alt="Logotipo Trinity Web" />
                <img className="white" src="/assets/img/root/logo-white.webp" alt="Logotipo Trinity Web" />
              </a>
              {/* Contacts */}
      ...
      <div className="vlt-offcanvas-menu">
        ...
        <div className="vlt-offcanvas-menu__footer">
          {/* Socials */}
          <div className="vlt-offcanvas-menu__socials">
      ...
      {/* Fixed Socials */}
      <div className="vlt-fixed-socials">
        <a href="https://conteudo.thetrinityweb.com.br/" target="_blank" aria-label="Blog">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 32 32" style={{fill: '#000000'}}>
      ...
      <main className="vlt-main">
        ...
        <div className="vlt-fullpage-slider" data-loop-top="" data-loop-bottom="" data-speed="800">
          ...
          <div className="vlt-section pp-scrollable" data-anchor="Home" data-brightness="dark"
            style={{backgroundImage: 'url(/assets/img/root/red-background.webp)'}}>
              ...
              <div className="vlt-section__content">
                ...
                <div className="vlt-section__particles">
                  <div className="vlt-particle vlt-fade-in-left vlt-custom--1451"
                    style={{backgroundImage: 'url(/assets/img/root/plus-dark-pattern.webp)', transitionDuration: '1s'}}>
                  </div>
                  <div className="vlt-particle d-none d-xl-block vlt-fade-in-right vlt-custom--1512"
                    style={{backgroundImage: 'url(/assets/img/root/elipse-home-slide.webp)', transitionDuration: '1.5s', transitionDelay: '300ms'}}>
                  </div>
          ...
          {/* Serviços Section */}
          <div className="vlt-section pp-scrollable" id="servicos-section" data-anchor="Servicos" data-brightness="light">
            <div className="vlt-section__vertical-align">
              <div className="vlt-section__content">
                {/* Particles */}
                <div className="vlt-section__particles">
                  <div className="vlt-particle vlt-custom--1259 vlt-fade-in-right"
                    style={{backgroundImage: 'url(/assets/img/root/plus-light-pattern.webp)', animationDelay: '750ms'}}>
                  </div>
                  <div className="vlt-particle vlt-custom--2355 vlt-fade-in-left"
                    style={{backgroundImage: 'url(/assets/img/root/elipse-light.webp)', animationDelay: '500ms'}}>
                  </div>
                </div>
                <div className="container">
                  <div className="row">
                      ...
                      <div className="row">
                          ...
                          <div className="vlt-animated-block" style={{animationDelay: '200ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              <p className="vlt-services__title">
                                <a target="_blank" href="https://conteudo.thetrinityweb.com.br/blog/conheca-o-que-e-web-design-e-o-que-faz/">
                                  Web Design
                                </a>
                              </p>
                              <p className="vlt-services__text">
                                Desenvolvimento de sites institucionais, blogs e lojas virtuais. Sempre utilizando as
                                melhores práticas em <i>User Experience (UX)</i> e <i>User Interface (UI)</i>.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow" target="_blank"
                        ...
                        <div className="col-md-4">
                          <div className="vlt-animated-block" style={{animationDelay: '300ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              <p className="vlt-services__title">
                                <a href="https://conteudo.thetrinityweb.com.br/blog/como-fazer-a-otimizacao-de-seu-site/" target="_blank">
                                  Otimização
                                </a>
                              </p>
                              <p className="vlt-services__text">
                                Otimizamos o site para ter as melhores notas possíveis para o Google, utilizando as métricas do <i>Core Vitals</i> e <i>GTMetrix</i>.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow"
                                href="https://conteudo.thetrinityweb.com.br/blog/como-fazer-a-otimizacao-de-seu-site/" target="_blank">
                                <span className="vlt-link-with-arrow__text">Veja mais</span>
                                <span className="vlt-link-with-arrow__icon">🡒</span>
                              </a>
                            </div>
                        ...
                        <div className="col-md-4">
                          <div className="vlt-animated-block" style={{animationDelay: '400ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              <p className="vlt-services__title">
                                <a href="https://conteudo.thetrinityweb.com.br/blog/manutencao-de-seu-site/" target="_blank">
                                  Manutenção / Segurança
                                </a>
                              </p>
                              <p className="vlt-services__text">
                                Sua aplicação precisa sempre estar segura, recebendo atualizações de segurança e realizar um backup frequentemente.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow"
                                href="https://conteudo.thetrinityweb.com.br/blog/manutencao-de-seu-site/" target="_blank">
                                <span className="vlt-link-with-arrow__text">Veja mais</span>
                                <span className="vlt-link-with-arrow__icon">🡒</span>
                              </a>
                            </div>
                        ...
                        <div className="col-md-4">
                          <div className="vlt-animated-block" style={{animationDelay: '500ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              <p className="vlt-services__title">
                                <a href="https://conteudo.thetrinityweb.com.br/blog/branding-conheca-mais-sobre/">
                                  Branding
                                </a>
                              </p>
                              <p className="vlt-services__text">
                                Criamos sua identidade visual (Logotipo, Slogans, Paleta de Cores, etc.), para poder ser utilizado em seu site e em suas redes sociais.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow"
                        ...
                        <div className="col-md-4">
                          <div className="vlt-animated-block" style={{animationDelay: '500ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              <p className="vlt-services__title">
                                <a target="_blank" href="https://conteudo.thetrinityweb.com.br/blog/marketing-de-conteudo-e-seus-beneficios/">
                                  Conteúdo
                                </a>
                              </p>
                              <p className="vlt-services__text">
                                Para um desempenho melhor no Google, conseguindo cliques orgânicos. Criamos todo conteúdo para seu Blog e suas Redes Sociais. Sempre utilizando as melhores práticas.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow" target="_blank"
                        ...
                        <div className="col-md-4">
                          <div className="vlt-animated-block" style={{animationDelay: '500ms', animationDuration: '700ms'}}>
                            <div className="vlt-services">
                              ...
                              <p className="vlt-services__text">
                                Criamos estratégias para aumentar o tráfego em seu site e em suas redes sociais. Focando no crescimento dos leads, para seu negócio.
                              </p>
                              <a className="vlt-services__link vlt-link-with-arrow" href="#">
                                <span className="vlt-link-with-arrow__text">Veja mais</span>
                                <span className="vlt-link-with-arrow__icon">🡒</span>
                              </a>
                            </div>
            ...
            <div className="vlt-section__vertical-align">
              <div className="vlt-section__content">
                ...
                <div className="vlt-section__ken-burn-background">
                  <img src="/assets/img/bg-depoimentos.webp" alt="" />
                </div>
                <div className="container">
                  <div className="row">
                    <div className="col-lg-10 offset-lg-1">
                      ...
                      <div className="customer-logos slider">
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/rdl.webp" alt="Resumo do Livro" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-01.webp" alt="Tiken" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-02.webp" alt="Pousada LeAnge" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-03.webp" alt="Equilibrio das Cartas" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-04.webp" alt="W Trindade Transportes" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-05.webp" alt="Tutto Buono" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-06.webp" alt="IOP Journal" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-07.webp" alt="LDI Engenharia" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-08.webp" alt="Siles & Costa" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-09.webp" alt="Mookita" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-011.webp" alt="Adisa" height="150" width="150" />
                        </div>
                        <div className="slide-in-right slide">
                          <img src="/assets/img/root/cliente-012.webp" alt="Visconde" height="150" width="150" />
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <footer className="vlt-footer vlt-footer--fixed">
          ...
          <div className="vlt-footer-copyright">
            <p>&copy; <span id="current-year">-</span><br />Todos direitos reservados.</p>
          </div>
        </footer>
      </main>
    </>
