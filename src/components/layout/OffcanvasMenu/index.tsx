  ...
  return (
    <div className="vlt-offcanvas-menu">
      <div className="vlt-offcanvas-menu__header">
        ...
        {/* Menu Burger */}
        <Link 
          className="vlt-menu-burger vlt-menu-burger--opened js-offcanvas-menu-close"
      ...
      <nav className="vlt-offcanvas-menu__navigation">
        ...
        <ul className="sf-menu">
          ...
          <li data-menuanchor="Servicos">
            <Link href="#Servicos">Serviços</Link>
          </li>
          <li data-menuanchor="Portfolio">
            <Link href="https://conteudo.thetrinityweb.com.br/portfolio">Portfolio</Link>
          </li>
          <li data-menuanchor="Depoimentos">
            <Link href="#Depoimentos">Depoimentos</Link>
          </li>
          <li data-menuanchor="Blog">
            <Link target="_blank" href="https://conteudo.thetrinityweb.com.br/">Blog</Link>
          </li>
        </ul>
      </nav>
      ...
      <div className="vlt-offcanvas-menu__footer">
        ...
        <div className="vlt-offcanvas-menu__socials">
          <Link href="https://www.facebook.com/TheTrinityWeb/" aria-label="Facebook" target="_blank">
          ...
          <Link href="https://www.instagram.com/thetrinityweb/" aria-label="Instagram" target="_blank">
          ...
          <Link href="https://api.whatsapp.com/send?phone=5511952498126&text=Tudo%20bem?%20Poderia%20falar%20com%20alguem%20respons%C3%A1vel%20pela%20Trinity%20Web?" aria-label="WhatsApp" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24" style={{ fill: "#fff" }}>
